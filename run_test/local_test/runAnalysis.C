...
{
  // Task Name
  TString taskName = "CVE2025_Lambda_test3";
  // Dataset
...
#if !defined(__CINT__) || defined(__CLING__)
  // gInterpreter->LoadMacro("AliAnalysisTaskCVEPIDCMEDiff.cxx++");
  AliAnalysisTaskCVEPIDCMEDiff *task = nullptr;
  task = reinterpret_cast<AliAnalysisTaskCVEPIDCMEDiff*>(gInterpreter->ExecuteMacro("/Users/wangchunzheng/alice/AliPhysics/PWGCF/FLOW/macros/AddTaskCVEPIDCMEDiff.C"));
#else
  // gROOT->LoadMacro("AliAnalysisTaskCVEPIDCMEDiff.cxx++");
  gROOT->LoadMacro("/Users/wangchunzheng/alice/AliPhysics/PWGCF/FLOW/macros/AddTaskCVEPIDCMEDiff.C");
  AliAnalysisTaskCVEPIDCMEDiff *task = AddTaskCVEPIDCMEDiff();
#endif
  ...
  if (local)
  {
    ...
    if(isMC) {
      if (dataset.EqualTo("LHC18q") || dataset.EqualTo("LHC18r")) chain->Add("/Users/wangchunzheng/alice/sim/2020/LHC20e3a/295585/AOD243/0001/AliAOD.root");
    } else {
  ...
  else
  {
    ...
    alienHandler->SetAdditionalLibs("AliAnalysisTaskCVEPIDCMEDiff.cxx AliAnalysisTaskCVEPIDCMEDiff.h");
    alienHandler->SetAnalysisSource("AliAnalysisTaskCVEPIDCMEDiff.cxx");
    // select the aliphysics version. all other packages
    // are LOADED AUTOMATICALLY!
    alienHandler->SetAliPhysicsVersion("vAN-20250524_O2-1");
